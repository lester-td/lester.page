...
<head>
  ...
  <title>portraits — shot by lester</title>
...
<body>
  <header class="mobile-header">
    ...
    <div class="page-title">portraits<div class="menu-open"><i class="fa fa-bars" aria-hidden="true"></i></div></div>
  </header>

  <main class="layout">
    <div class="main-content">
      <div class="gallery portraits"></div>
...
<ul>
  <li><a href="./">home</a></li>
  <li><a href="portraits" class="active-page">portraits</a></li>
