...
<head>
  ...
  <title>other — shot by lester</title>
...
<body>
  <header class="mobile-header">
    ...
    <div class="page-title">other<div class="menu-open"><i class="fa fa-bars" aria-hidden="true"></i></div></div>
  </header>
  <main class="layout">
    <div class="main-content">
      <p class="heading">fictional vogue covers</p>
      <div class="gallery vogue"></div>
    </div>
    <aside class="sidebar">
...
<ul>
  ...
  <li><a href="other" class="active-page">other</a></li>
