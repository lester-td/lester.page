...
<head>
  ...
  <title>film — shot by lester</title>
...
<body>
  <header class="mobile-header">
    ...
    <div class="page-title">film<div class="menu-open"><i class="fa fa-bars" aria-hidden="true"></i></div></div>
  </header>
  <main class="layout">
    <div class="main-content">
      <div class="gallery film"></div>
    </div>
    <aside class="sidebar">
...
<ul>
  ...
  <li><a href="film" class="active-page">film</a></li>
