...
<body>
  <header class="mobile-header">
    ...
    <div class="page-title">blog<div class="menu-open"><i class="fa fa-bars" aria-hidden="true"></i></div></div>
  </header>
...
<ul>
  ...
  <li><a href="blog" class="active-page">blog</a></li>
</ul>
</nav>
