...
<head>
  ...
  <title>streets — shot by lester</title>
...
<body>
  <header class="mobile-header">
    ...
    <div class="page-title">streets<div class="menu-open"><i class="fa fa-bars" aria-hidden="true"></i></div></div>
  </header>

  <main class="layout">
    <div class="main-content">
      <div class="gallery streets"></div>
...
<ul>
  ...
  <li><a href="streets" class="active-page">streets</a></li>
