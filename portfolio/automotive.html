...
<head>
  ...
  <title>automotive — shot by lester</title>
...
<body>
  <header class="mobile-header">
    ...
    <div class="page-title">automotive<div class="menu-open"><i class="fa fa-bars" aria-hidden="true"></i></div></div>
  </header>

  <main class="layout">
    <div class="main-content">
      <div class="gallery automotive"></div>
...
<ul>
  ...
  <li><a href="automotive" class="active-page">automotive</a></li>
